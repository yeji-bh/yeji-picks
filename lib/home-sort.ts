...
export function getSavedSort(mode: HomeViewMode): HomeSort {
  if (typeof window === "undefined") {
    ...
    if (mode === "nailArt" || mode === "phoneCase" || mode === "perfume" || mode === "lovedItem" || mode === "cosmetic") return DEFAULT_GALLERY_SORT;
  ...
  try {
    ...
    if (mode === "nailArt" || mode === "phoneCase" || mode === "perfume" || mode === "lovedItem" || mode === "cosmetic") {
